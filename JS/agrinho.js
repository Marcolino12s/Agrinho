...
const translations = {
  pt: {
    ...
    areaTotal: "Área total da propriedade (ha)",
  ...
  en: {
    ...
    saudacao: {
      morning: "🌅 Good morning! Seja bem-vindo ao AgroNá.",
      afternoon: "☀️ Good afternoon! Seja bem-vindo ao AgroNá.",
      night: "🌙 Good evening! Seja bem-vindo ao AgroNá."
    }
  },
  ...
  es: {
    ...
    saudacao: {
      morning: "🌅 ¡Buenos días! Seja bem-vindo ao AgroNá.",
      afternoon: "☀️ ¡Buenas tardes! Seja bem-vindo ao AgroNá.",
      night: "🌙 ¡Buenas noches! Seja bem-vindo ao AgroNá."
    }
  }
};
